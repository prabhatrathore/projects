...
const updateBlog = async function (req, res) {
    try {
        ...
        if (Object.prototype.hasOwnProperty.call(requestBody, 'body')) {

            updatedBlogData.body = body;
        }
        if (Object.prototype.hasOwnProperty.call(requestBody, 'category')) {

            updatedBlogData.category = category;
        }
        if (Object.prototype.hasOwnProperty.call(requestBody, 'subcategory')) {

            updatedBlogData.subcategory = subcategory;
        }
        if (Object.prototype.hasOwnProperty.call(requestBody, 'tags')) {
...
const deleteBlogByID = async function (req, res) {
    try {
        ...
        await blogModel.findOneAndUpdate({ _id: blogId }, { isDeleted: true, deletedAt: new Date() })
...
module.exports = { createBlog, listBlog, updateBlog,  deleteBlogByID,  deleteBlogByParams}